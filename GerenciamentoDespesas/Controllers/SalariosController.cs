...
namespace GerenciamentoDespesas.Controllers
{
    public class SalariosController : Controller
    {
        ...
        {
            ViewData["MesId"] = new SelectList(_context.Meses.Where(s =>s.MesesId != s.Salarios.MesId), "MesesId", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("SalarioId,MesId,Valor")] Salarios salarios)
        {
            ...
            ViewData["MesId"] = new SelectList(_context.Meses.Where(s => s.MesesId != s.Salarios.MesId), "MesesId", "Nome", salarios.MesId);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["MesId"] = new SelectList(_context.Meses.Where(s => s.MesesId == salarios.MesId), "MesesId", "Nome", salarios.MesId);
            return View(salarios);
        }
